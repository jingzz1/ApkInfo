...
public class ShapeImageView extends AppCompatImageView {
    ...
    private int DEFAULT_SHAPE        = SHAPE_RECT;
    private int DEFAULT_BACKGROUND   = Color.LTGRAY;
    private int DEFAULT_TEXT_COLOR   = Color.WHITE;
    private int DEFAULT_BORDER_COLOR = Color.WHITE;
    private int DEFAULT_RADIUS       = 0xA;
    private int DEFAULT_TEXT_SIZE    = 0xE;
    private int DEFAULT_MIN_PADDING  = 0x5;
...
//        mBackgroundColor = ta.getColor(R.styleable.ShapeImageView_siv_backgroundColor, -1);
//        if(mBackgroundColor == -1)
//            mBackgroundColor = getRandColor();
     ...
     * 需求：浅色
     * H:Hue 色相 取值：0-360
     * S:Saturation 饱和度 取值：0-1 值越高颜色越深
     * V:Value 明度 取值0-1 值越高亮度越高（即颜色越浅）
     */
    private int getRandColor() {
        Random rand = new Random();
        return Color.HSVToColor(new float[]{rand.nextInt(360),0.2f,rand.nextFloat()/2+0.5f});
    }
